...
export default function CurrentLocation() {
  ...
  return (!isGeolocationAvailable ? (
    ...
    <>
      <h1 className="mb-8 bg-gradient-to-r from-blue-200 via-yellow-200 to-gray-100 text-transparent bg-clip-text md:text-6xl text-center sm:text-3xl">
        Weather Report in {location.country_name}
      </h1>
      <div className="cardContainer z-[1]">
        <div className="card sm:w-[80vw]">
          ...
          <h1 className="city">{location.state} {location.city ? ", " + location.city : ""}</h1>
          <p className="weather">{weather?.weather?.[0].description}</p>

          <Image src={icon ? `http://openweathermap.org/img/w/${weather?.weather?.[0].icon}.png` : "https://cdn-icons-png.flaticon.com/512/1146/1146869.png?w=740&t=st=1690038121~exp=1690038721~hmac=a7ee890d91d128fe311a6ca286c3fa85468ae227eeb479f0769a4d5f79225b02"} alt="Weather API Icon" width={48} height={48} />
